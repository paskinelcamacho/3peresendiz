...
if ($err == 0) {
	...
	$query = ("INSERT INTO usuarios (nombre,apaterno,amaterno,telefono,correo,usuario,contrasenia) VALUES ('$nombre','$apaterno','$amaterno','$telefono','$correo','$nombre.$apaterno','md5($contrasenia)')");
